...
![unnamed-chunk-2-1](figure/unnamed-chunk-2-1.png)
```
...
![unnamed-chunk-3-1](figure/unnamed-chunk-3-1.png)
```
...
![unnamed-chunk-6-1](figure/unnamed-chunk-6-1.png)

#Create Histogram to show difference. 
hist(steps_by_day$steps, main = paste("Total Steps Each Day"), col="red", xlab="Number of Steps", add=T)
legend("topright", c("Imputed", "Non-imputed"), col=c("blue", "red"), lwd=10)
![unnamed-chunk-10-1](figure/unnamed-chunk-10-1.png)
```
